...
impl <T: Object> ObjWrapper<T> {
   unsafe fn _unsafe_from(obj: Rc<dyn Object>) -> ObjWrapper<T> {
      let obj = obj.clone();
      use std::mem::transmute;
      ObjWrapper(transmute::<&Rc<dyn Object>, &Rc<T>>(&obj).clone())
   }
}
...
pub trait Object : Debug + Display {
   ...
   default_func!(BINARY_ALL: qt_add, qt_add_l, qt_add_r, dyn Object);
   default_func!(BINARY_ALL: qt_sub, qt_sub_l, qt_sub_r, dyn Object);
   default_func!(BINARY_ALL: qt_mul, qt_mul_l, qt_mul_r, dyn Object);
   default_func!(BINARY_ALL: qt_div, qt_div_l, qt_div_r, dyn Object);
   default_func!(BINARY_ALL: qt_mod, qt_mod_l, qt_mod_r, dyn Object);
   default_func!(BINARY_ALL: qt_pow, qt_pow_l, qt_pow_r, dyn Object);
   ...
   default_func!(BINARY_ALL: qt_rgx, qt_rgx_l, qt_rgx_r, dyn Object);
