...
pub struct Operator {
   ...
   pub has_lhs: bool,
   pub has_rhs: bool,
   pub func: fn(Option<BoxedObj>, // lhs
                Option<BoxedObj>, // rhs
                &mut Universe, // stream
                &mut Universe, // enviro
                &Parser,       // parser
...
fn assign_fn(l: Option<BoxedObj>,
             r: Option<BoxedObj>,
             _: &mut Universe, // stream
